    ...
    return (
      <aside className="flex w-[56px] shrink-0 flex-col items-center border-r border-[color:var(--ui-outline-variant)] bg-[color:var(--ui-surface-high)] py-4">
        <button
          ...
          aria-label="Expand learn sidebar"
        ...
        <div className="mt-6 flex flex-1 flex-col items-center gap-3">
          <div className="rounded-full bg-[color:var(--ui-secondary-container)] px-2 py-1 text-[10px] font-semibold text-[color:var(--ui-on-secondary-container)]">
            1
          </div>
          <div className="rounded-full border border-[color:var(--ui-outline-variant)] px-2 py-1 text-[10px] font-semibold text-[color:var(--ui-text-muted)]">
            2
          </div>
          <div className="rounded-full border border-[color:var(--ui-outline-variant)] px-2 py-1 text-[10px] font-semibold text-[color:var(--ui-text-muted)]">
            3
    ...
    <aside className="flex w-[280px] shrink-0 flex-col border-r border-[color:var(--ui-outline-variant)] bg-[color:var(--ui-surface-high)] px-3 py-4">
      <div className="mb-6 px-3">
        <div className="mb-3 flex items-center justify-between gap-3">
          ...
          <button
            ...
            aria-label="Collapse learn sidebar"
      ...
      <div className="flex-1 space-y-1 overflow-y-auto">
        <SidebarGroupButton
          ...
          onClick={() => {
            setFoundationsExpanded((current) => !current);
          }}
        />
        {foundationsExpanded ? (
          <div className="ml-10 mt-1 space-y-1 border-l border-[color:var(--ui-outline-variant)] pl-4">
            <SidebarLink href="#foundations" label="Terminology" />
          </div>
        ) : null}
        ...
        {amExpanded ? (
          <div className="ml-10 mt-1 space-y-1 border-l border-[color:var(--ui-outline-variant)] pl-4">
            <SidebarLink href="#dsb-lc" label="DSB-LC" />
            <SidebarLink href="#dsb-sc" label="DSB-SC" />
            <SidebarLink href="#ssb" label="SSB" />
          </div>
        ) : null}
        ...
        {angleExpanded ? (
          <div className="ml-10 mt-1 space-y-1 border-l border-[color:var(--ui-outline-variant)] pl-4">
            <SidebarLink href="#fm" label="FM" />
            <SidebarLink href="#pm" label="PM" />
          </div>
        ) : null}
