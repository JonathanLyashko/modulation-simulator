...
export const RECORDED_MESSAGE_MAX_BANDWIDTH_HZ = 5_000;
export const RECORDED_MESSAGE_TARGET_SAMPLE_RATE = 12_000;
export const MAX_CARRIER_FREQUENCY = 20_000;
...
export const DEFAULT_FREQUENCY_MAGNITUDE_SCALE = 0.2;
export const DEFAULT_FREQUENCY_DB_SCALE = 10;
...
export const DEFAULT_FREQUENCY_PLOT_SETTINGS: FrequencyPlotSettings = {
  centerHz: 0,
  spanHz: 2_500,
  yScale: DEFAULT_FREQUENCY_MAGNITUDE_SCALE,
